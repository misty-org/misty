...
keys matches: `REDACTED_LEGACY_CREDENTIAL` ads this key is used
for signing.
...
```console
$ gpg --keyserver keyserver.ubuntu.com --receive-keys REDACTED_LEGACY_CREDENTIAL
...
gpg:                using DSA key REDACTED_LEGACY_CREDENTIAL
