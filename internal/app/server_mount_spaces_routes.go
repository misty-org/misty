...
func (s *Server) mountSpacesRoutes(prefix string, spaces *api.SpacesService, realtime *api.RealtimeService) {
	...
	s.Router.Get(prefix+"/spaces/{spaceID}/support-inbox", spaces.MistySupportInbox())
	...
	s.Router.Put(prefix+"/agent-instances/{instanceID}/capabilities", spaces.AgentInstanceCapabilities())
	s.Router.Get(prefix+"/agent-instances/{instanceID}/toolbox", spaces.AgentInstanceToolbox())
