...
use commands::{
    ...
    app_snapshot, archive_create,
    archive_extract, archive_list, claude_abort, claude_drain_events,
    ...
    explorer_cancel_drag_preparation, explorer_prepare_drag_items, explorer_prepare_open_item,
    ...
    explorer_queue_rename_items, explorer_rename_item, explorer_save_preview_item,
    explorer_set_open_association, extension_command_run, file_metadata_snapshot, file_sync_apply,
    file_sync_compare, file_sync_pair_remove, file_sync_pair_save, file_sync_pairs_snapshot,
    file_tools_checksum, file_tools_chmod, file_tools_create_symlink, file_tools_read_symlink,
    file_tools_set_readonly, open_terminal_at_path, operation_queue_cancel,
    operation_queue_cancel_batch, operation_queue_clear_terminal, operation_queue_pause,
    operation_queue_pause_all, operation_queue_pause_batch, operation_queue_redo,
    operation_queue_resolve_conflict, operation_queue_resume, operation_queue_resume_all,
    operation_queue_resume_batch, operation_queue_retry, operation_queue_retry_transfer,
    operation_queue_set_bandwidth_limit, operation_queue_set_transfer_profile,
    operation_queue_snapshot, operation_queue_undo, plugin_command_run, plugin_commands_snapshot,
    plugin_diagnostics_snapshot, plugin_panel_render, providers_backend_actions,
    providers_config_paths, providers_config_security, providers_configure_remote,
    providers_disconnect_remote, providers_harden_config, providers_job_cancel,
    providers_job_status, providers_refresh, providers_repair_config_security,
    ...
    smart_library_preflight_import, smart_library_prepare_previews, smart_library_resolve_assets, smart_library_scan,
