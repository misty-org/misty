...
import { createDesktopAppPreparation, prepareDesktopApps } from "./prepare-desktop-apps.mjs";
...
test("rechecks source freshness on later requests", async (t) => {
  ...
  const source = resolve(fixture.apps, "apps/planner/index.tsx");
  mkdirSync(resolve(fixture.apps, "apps/planner"), { recursive: true });
