...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    className={cn(
      ...
      "shadow-xs outline-none transition-colors focus-visible:border-charcoal-active",
  ...
  >
    <SwitchPrimitives.Thumb
      ...
      className={cn(
        ...
        "ring-1 ring-cream/15 transition-transform data-[state=checked]:translate-x-4",
