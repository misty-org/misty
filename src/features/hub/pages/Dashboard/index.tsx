...
const logs: Array<{
  ...
  },
  {
    ...
    description: "Embedded API, auth middleware, remote operations, and transfer service.",
    icon: Server,
  },
  {
    key: "misty-rclone",
      ...
      <div className="flex items-center justify-between gap-4 border-b border-white/[0.07] pb-4">
        <div>
          ...
          <p className="mt-1 text-sm text-text-muted">
            Runtime logs for Misty, Hub, embedded runtime, and Rclone.
          </p>
        </div>
        <button
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-text">
                {clipboard?.proxy_running ? "Embedded online" : "Embedded stopped"}
              </p>
            </div>
          </div>
          <p className="mt-3 truncate text-xs text-text-muted">
            Embedded invoke transport
          </p>
        </div>
