import type { MultiPanelClosedPane, MultiPanelPane, MultiPanelTab } from "@/features/workspace";
import type {
  DirectoryListing,
  NativeWorkspace,
...
import type { ExplorerSortState, PaneExplorerState } from "../../model/interfaces/store/types";
