import type { WorkflowTemplate } from "@/models/interfaces/features/workflows/templates";
export type { WorkflowTemplate } from "@/models/interfaces/features/workflows/templates";
import { createWorkflowNode, workflowNodeRegistry } from "./v2";
