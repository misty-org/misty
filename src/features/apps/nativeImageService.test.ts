...
it("uses an SDK caller's Space and never invokes a preview after authorization fails", async () => {
  ...
  await expect(
    invokeFilesImage("explorer_generate_image_thumbnail", { path: "/chosen/image.png" }, "project"),
