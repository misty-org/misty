...
This directory contains Misty's built-in editor workspace and language services, including colocated tests. Its component entry and workspace code compile into Misty; they have no separate installation or update lifecycle.
