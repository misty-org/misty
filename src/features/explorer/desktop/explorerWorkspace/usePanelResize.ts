...
import { useMultiPanelStore } from "@/features/workspace/useMultiPanelStore";
import type { ResizeTarget } from "@/models/types/features/explorer/desktop";
import { explorerWorkspaceNeedsSave, scheduleExplorerWorkspaceSave } from "@/stores/explorer";
