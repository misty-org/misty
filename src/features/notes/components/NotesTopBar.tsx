...
const topBarClass = "misty-spaces-toolbar flex h-11 shrink-0 items-center gap-2 px-3";
      ...
      <header className={topBarClass}>
        <div className="relative min-w-[180px] flex-1">
          ...
          <Input
            ...
            className="h-8 rounded-md border-border/70 bg-muted/30 pl-8 pr-8 text-[13px] shadow-none"
          />
          {props.query ? (
            <IconButton
              title="Clear search"
