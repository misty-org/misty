...
This directory contains Misty's built-in tasks, agenda, and roadmaps, including colocated tests. Its component entry and workspace code compile into Misty; they have no separate installation or update lifecycle.
