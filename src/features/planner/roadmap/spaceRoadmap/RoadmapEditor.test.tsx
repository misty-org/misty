...
vi.mock("@/features/planner/roadmap/spaceRoadmap/RoadmapCanvas", () => ({
  RoadmapCanvas: () => <main aria-label="Roadmap canvas">Canvas</main>,
}));

vi.mock("@/features/planner/roadmap/spaceRoadmap/RoadmapNodeDrawer", () => ({
  RoadmapNodeDrawer: ({ open }: { open: boolean }) =>
    open ? <aside aria-label="Node tools">Node tools</aside> : null,
}));

vi.mock("@/features/planner/roadmap/spaceRoadmap/RoadmapExecutionRail", () => ({
  RoadmapExecutionRail: () => <aside aria-label="Daily plan">Daily plan</aside>,
}));

vi.mock("@/features/planner/roadmap/spaceRoadmap/RoadmapOutline", () => ({
  RoadmapOutline: () => <div>Outline</div>,
}));

vi.mock("@/features/planner/roadmap/spaceRoadmap/RoadmapInspector", () => ({
