...
const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className, size = "default", ...props }, ref) => (
  <div
    ref={ref}
    data-slot="card"
    data-size={size}
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn("font-heading text-base font-medium leading-normal group-data-[size=sm]/card:text-sm", className)}
    {...props}
  />
))
