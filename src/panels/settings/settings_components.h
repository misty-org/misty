...
struct SettingsSectionProps {
    ...
    ImVec4 title_color = ImVec4(0.945f, 0.933f, 0.910f, 1.0f);
    ImVec4 divider_color = ImVec4(0.153f, 0.153f, 0.165f, 1.0f);
...
inline constexpr ImVec4 kSettingsHeaderTextColor = ImVec4(0.945f, 0.933f, 0.910f, 1.0f);
inline constexpr ImVec4 kSettingsBodyTextColor = ImVec4(0.788f, 0.769f, 0.737f, 1.0f);
inline constexpr ImVec4 kSettingsMutedTextColor = ImVec4(0.620f, 0.596f, 0.561f, 1.0f);
inline constexpr ImVec4 kSettingsDividerColor = ImVec4(0.153f, 0.153f, 0.165f, 1.0f);
inline constexpr ImVec4 kSettingsSuccessTextColor = ImVec4(0.475f, 0.729f, 0.561f, 1.0f);
inline constexpr ImVec4 kSettingsControlBgColor = ImVec4(0.043f, 0.051f, 0.059f, 1.0f);
inline constexpr ImVec4 kSettingsControlBorderColor = ImVec4(0.153f, 0.153f, 0.165f, 1.0f);
inline constexpr ImVec4 kSettingsControlTextColor = ImVec4(0.945f, 0.933f, 0.910f, 1.0f);
