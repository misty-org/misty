import { SpaceRequestError, spaceRequest } from "@/stores/spaces/useSpacesBackendStore";
import type {
  NotionAppendPayload,
  NotionBlock,
  NotionClient,
...
import type { NoteWriteErrorCode } from "@/models/types/features/notes/capabilities";
...
export function createNotionApiClient(): NotionClient {
  return {
    ...
    async connect() {
      ...
      const { openExternalLink } = await import("@/platform/openExternalLink");
