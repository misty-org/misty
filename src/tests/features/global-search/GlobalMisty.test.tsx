...
vi.mock("@/features/global-search/globalMistyApi", async (importOriginal) => {
  const original = await importOriginal<typeof import("@/features/global-search/globalMistyApi")>();
  return {
    ...original,
    globalMistyApi: {
