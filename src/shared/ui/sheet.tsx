...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    ...
    className={cn(
      "fixed inset-0 z-[2147483000] bg-black/45 duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:pointer-events-none",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-[2147483100] gap-4 bg-charcoal-card p-6 text-cream shadow-xl transition ease-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:pointer-events-none",
  {
    variants: {
      side: {
