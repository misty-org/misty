import type { ClipboardOperation, MountedDevice } from "../../../api/types";
...
export function invalidTransferReason(items: ExplorerDragItem[], destination: string): string | null {
