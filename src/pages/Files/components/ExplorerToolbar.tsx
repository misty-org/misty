  ...
  return (
    <header className={toolbarStyles.root}>
      ...
      <Toolbar
        variant="bare"
        label="File actions"
        className={toolbarStyles.actionRow}
      >
        <div className={toolbarStyles.actionLeft}>
          ...
          <IconButton size="sm" label="Cut" onClick={props.onCut}>
            <Scissors size={18} />
          </IconButton>
          <IconButton size="sm" label="Copy" onClick={props.onCopy}>
            <Copy size={18} />
          </IconButton>
          <IconButton size="sm" label="Paste" onClick={props.onPaste}>
            <Clipboard size={18} />
          </IconButton>
          <IconButton size="sm" label="Rename" onClick={props.onRename}>
            <Pencil size={18} />
          </IconButton>
          <IconButton size="sm" label="Delete" onClick={props.onDelete}>
            <Trash2 size={18} />
          </IconButton>
        </div>
      </Toolbar>
