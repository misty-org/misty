...
export const toolbarStyles = {
  root:
    "min-w-0 overflow-visible bg-background text-foreground max-[720px]:overflow-x-auto max-[720px]:overflow-y-hidden max-[720px]:[scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
  navRow:
    "grid min-h-14 min-w-0 grid-cols-[auto_minmax(240px,1fr)_auto] items-center gap-3 overflow-visible px-3 py-2 max-[980px]:grid-cols-[auto_minmax(180px,1fr)_auto]",
  actionRow:
    "grid min-h-12 min-w-0 grid-cols-[minmax(0,1fr)_auto] items-center justify-between gap-3 overflow-hidden border-t border-border/70 px-3 py-1.5",
  ...
  pathBar:
    "flex h-9 min-w-0 items-center gap-0.5 overflow-x-auto overflow-y-hidden rounded-lg border border-input bg-muted/30 px-2 shadow-sm [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
  pathBarEditing: "border-ring ring-2 ring-ring/20",
  pathButton:
    "h-8 min-w-fit flex-none gap-0 rounded-md px-1.5 text-foreground shadow-none hover:bg-accent",
  pathInput:
  ...
  commandSearch:
    "flex h-9 w-full min-w-0 items-center gap-2 rounded-lg border border-input bg-muted/30 px-2 text-muted-foreground shadow-sm focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/20 max-[980px]:w-full max-[720px]:min-w-40",
  searchButton:
    "size-8 shrink-0 rounded-md text-muted-foreground hover:text-foreground",
  commandInput:
  ...
  paletteButton:
    "min-h-11 items-start gap-2.5 rounded-md px-2.5 py-2",
  paletteResultButton:
  ...
  newButton:
    "h-9 gap-1.5 rounded-lg px-3 text-foreground shadow-none",
} as const;

export const paneToolbarActionStyles = {
  section:
    "h-9 min-h-0 flex-none gap-px overflow-visible rounded-lg border border-border/70 bg-muted/30 p-0.5",
  button:
    "size-8 rounded-md text-muted-foreground hover:text-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground",
