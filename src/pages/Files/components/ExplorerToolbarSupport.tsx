...
export const toolbarStyles = {
  ...
  navRow: "grid min-w-0 grid-cols-[auto_minmax(240px,1fr)_auto] items-center gap-3 overflow-visible px-3 py-1.5 max-[980px]:grid-cols-[auto_minmax(180px,1fr)_auto]",
  ...
  pathBar:
    "flex h-8 min-w-0 items-center gap-0.5 overflow-x-auto overflow-y-hidden rounded-lg border border-[var(--misty-divider-default)] bg-transparent px-2.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
  ...
  commandSearch:
    "!flex !h-8 !w-full !min-w-0 !items-center !gap-2 rounded-lg border border-transparent bg-transparent px-2.5 !text-[var(--misty-text-subtle)] !normal-case focus-within:border-[var(--misty-interaction-focus)] focus-within:shadow-[0_0_0_2px_var(--misty-focus-ring)] max-[980px]:w-full max-[720px]:min-w-40",
  searchButton:
    "grid size-8 shrink-0 place-items-center rounded-lg border border-transparent bg-transparent p-0 text-[var(--misty-text-muted)] hover:bg-[var(--misty-neutral-hover-bg,var(--misty-surface-hover))] hover:text-[var(--misty-text)] focus-visible:border-[var(--misty-interaction-focus)] focus-visible:outline-none focus-visible:shadow-[0_0_0_2px_var(--misty-focus-ring)]",
  commandSearchGroup:
