...
export const toolbarStyles = {
  root:
    "min-w-0 overflow-visible border-b border-transparent bg-transparent max-[720px]:overflow-x-auto max-[720px]:overflow-y-hidden max-[720px]:[scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
  ...
  actionRow: "grid min-h-12 min-w-0 grid-cols-[minmax(0,1fr)_auto] items-center justify-between gap-3 overflow-hidden border-t border-transparent px-3 py-1.5",
  ...
  pathBar:
    "flex h-8 min-w-0 items-center gap-0.5 overflow-x-auto overflow-y-hidden rounded-lg border border-transparent bg-transparent px-2.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
  ...
  commandSearch:
    "!flex !h-8 !w-full !min-w-0 !items-center !gap-2 rounded-lg border border-transparent bg-transparent px-2.5 !text-[var(--misty-text-subtle)] !normal-case focus-within:border-[var(--misty-border-strong)] focus-within:shadow-[0_0_0_2px_rgba(241,243,244,0.08)] max-[980px]:w-full max-[720px]:min-w-40",
  commandSearchGroup:
    "grid min-w-0 grid-cols-[minmax(0,1fr)_auto] items-center gap-1.5",
  commandSearchMode: "border-[var(--misty-border-strong)] bg-[var(--misty-neutral-selected-bg,var(--misty-surface-selected))] text-[var(--misty-text)]",
  ...
  newButton:
    "inline-flex h-9 items-center justify-center gap-1.5 whitespace-nowrap rounded-lg border border-transparent bg-transparent px-3 py-0 leading-none text-[var(--misty-text)] hover:bg-[var(--misty-neutral-hover-bg,var(--misty-surface-hover))] hover:border-[var(--misty-border-strong)]",
  newMenu: "grid w-52 gap-0.5 rounded-[13px] border border-[var(--misty-border)] bg-[var(--misty-glass)] p-2 shadow-[0_18px_40px_var(--misty-shadow)]",
  newItem:
  ...
  overflowMenu: "grid w-60 gap-0.5 rounded-[13px] border border-[var(--misty-border)] bg-[var(--misty-glass)] p-2 shadow-[0_18px_40px_var(--misty-shadow)]",
