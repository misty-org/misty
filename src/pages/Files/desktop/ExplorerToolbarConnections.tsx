...
import { newestUndoableTransfer, redoLatestTransferOperation, runExplorerCommand, runPluginCommand, transferTypeLabel, undoLatestTransferOperation } from "./ExplorerCommands";
...
export const ConnectedExplorerToolbar = memo(function ConnectedExplorerToolbar(props: {
  ...
  const onCommandQueryMode = useCallback((mode: "search" | "filter") => {
...
export const ExplorerPaneHeaderActions = memo(function ExplorerPaneHeaderActions(props: { paneId: string }) {
  return (
