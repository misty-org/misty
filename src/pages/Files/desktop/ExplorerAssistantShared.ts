...
export function selectedPathsAcrossPanes(panes: ReturnType<typeof useExplorerStore.getState>["panes"]): string[] {
...
export function buildMikaPrompt(userPrompt: string, workingDirectory: string, selectedPaths: string[]): string {
