const pluginTabMenuStyles = {
  menu:
    "fixed z-[2147483000] grid overflow-auto rounded-[11px] border border-[#323232] bg-[rgba(17,17,17,0.98)] p-1.5 text-[#eeeeee] shadow-[0_18px_42px_rgba(0,0,0,0.48)]",
  header:
  ...
  itemUsable:
    "border-[var(--misty-border-soft)] bg-[var(--misty-neutral-control-bg,var(--misty-surface-2))] text-[#eeeeee]",
  itemSelected:
    "border-[var(--misty-neutral-border,var(--misty-border-strong))] bg-[var(--misty-neutral-selected-bg,var(--misty-surface-selected))] text-[#ffffff] shadow-[inset_2px_0_0_#8f8f8f]",
  itemText:
...
const extensionsPanelStyles = {
  ...
  itemSelected:
    "z-[1] border-[var(--misty-border-soft)] border-b-transparent bg-[var(--misty-neutral-selected-bg,var(--misty-surface-selected))] text-[#eeeeee] shadow-[0_-1px_0_rgba(255,255,255,0.05)]",
  itemText:
  ...
  tabClose:
    "grid size-[19px] place-items-center rounded-full text-[#8f8f8f] hover:bg-[var(--misty-neutral-hover-bg,var(--misty-surface-hover))] hover:text-[#f7f7f7]",
  host:
...
const explorerTrayStyles = {
  ...
  trigger:
    "relative grid h-[26px] w-[30px] place-items-center rounded-md border-0 bg-transparent p-0 text-[#adadad] hover:bg-[var(--misty-neutral-hover-bg,var(--misty-surface-hover))] hover:text-[#eeeeee] disabled:cursor-default disabled:opacity-40 disabled:hover:bg-transparent disabled:hover:text-[#adadad] aria-expanded:bg-[var(--misty-neutral-selected-bg,var(--misty-surface-selected))] aria-expanded:text-[#eeeeee] max-[720px]:h-7 max-[720px]:w-8",
  triggerActive: "bg-[var(--misty-neutral-selected-bg,var(--misty-surface-selected))] text-[#eeeeee]",
  badge:
