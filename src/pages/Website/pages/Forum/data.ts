...
export const threads: Thread[] = [
  ...
  },
  {
    ...
    avatar: "SK",
    date: "Mar 2026",
    body: "I wrote a small Python script that uses the Misty Api to automatically sort files in my Google Drive by file type. Photos go into /Photos, documents into /Documents, etc. Runs on a cron job once a day.\n\nHappy to share the script if anyone's interested — it's about 60 lines of code.",
    replies: [
      {
        author: "alex_dev",
        avatar: "AD",
        date: "Mar 2026",
        body: "Please share! I've been looking for exactly this kind of workflow.",
        likes: 14,
      },
      {
        author: "infra_eng",
        avatar: "IE",
        date: "Mar 2026",
        body: "This is awesome. Would love to see a community recipes/scripts section in the forum.",
        likes: 10,
      },
      {
        author: "script_kid",
