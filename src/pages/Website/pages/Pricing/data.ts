...
export const pricingFaqs: PricingFaq[] = [
  ...
  },
  {
    ...
    a: "Personal is $25 and includes up to 5 devices, the extension ecosystem, AI file workflows, and the shared LAN Misty clipboard. Unlimited is $89, removes the device cap, adds premium support during PST work hours, and gets faster incremental bug-fix updates.",
  },
  {
  ...
  },
  {
    ...
    a: "Misty never touches your files. Cloud-provider communication runs through Misty's embedded local runtime. Your credentials and file data never leave your device.",
  },
];
