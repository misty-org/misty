...
export function compareLibraryItems(left: SpaceLibraryItem, right: SpaceLibraryItem, sort: NonNullable<LibraryItemQuery["sort"]>, direction: NonNullable<LibraryItemQuery["direction"]>) {
...
export function libraryDateGroupLabel(item: SpaceLibraryItem, sort: NonNullable<LibraryItemQuery["sort"]>) {
...
export function formatTime(value: string) { return new Date(value).toLocaleString([], { month: "short", day: "numeric", hour: "numeric", minute: "2-digit" }); }
