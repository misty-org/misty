...
export type LibraryCollectionKind = "recent" | "months" | "years" | "recent-days" | "utility" | "collections" | "favorites" | "hidden" | "deleted" | "people" | "albums" | "groups" | "memory" | "trip" | "map" | "duplicate" | "shared" | "imports";

export const libraryCollectionKinds = new Set<LibraryCollectionKind>(["recent", "months", "years", "recent-days", "utility", "collections", "favorites", "hidden", "deleted", "people", "albums", "groups", "memory", "trip", "map", "duplicate", "shared", "imports"]);
...
export function useSpaceLibraryData(spaceId: string) {
  ...
  const sensitiveCollectionScope: "" | "hidden" | "recently_deleted" = collection === "hidden" ? "hidden" : collection === "deleted" ? "recently_deleted" : "";
