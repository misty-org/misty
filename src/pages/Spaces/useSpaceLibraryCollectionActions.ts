...
export function useSpaceLibraryCollectionActions(data: SpaceLibraryData, itemActions: SpaceLibraryItemActions) {
  const {
    spaceId, librarySearchParams, setLibrarySearchParams, requestedCollection, requestedCollectionId,
    activeSpace, canEditLibrary, collection, setCollection, selectedCollectionId, setSelectedCollectionId,
    sort, setSort, setDirection, mediaType, setMediaType, albums, setAlbums, albumFolders, setAlbumFolders,
    selectedAlbumFolderId, setSelectedAlbumFolderId, groups, setGroups, people, setPeople, peoplePolicy,
    setPeoplePolicy, discovery, setDiscovery, sharedReferences, outgoingReferences, setOutgoingReferences,
    pins, setPins, importHistory, searchFacets, visibleItems, setVisibleItems, setItems, selectedItems,
    setSelectedItemIds, bulkSaving, setBulkSaving, setLocalError, currentAlbum, currentPerson,
    currentDiscoveryGroup, canReorderAlbum, draggedAlbumItemId, setDraggedAlbumItemId, albumDialogMode,
    setAlbumDialogMode, albumName, setAlbumName, albumDescription, setAlbumDescription, albumCoverItemId,
    setAlbumCoverItemId, albumSaving, setAlbumSaving, personDialogMode, setPersonDialogMode, personName,
    setPersonName, personKind, setPersonKind, personCoverItemId, setPersonCoverItemId, personSaving,
    setPersonSaving, textDialog, setTextDialog, textDialogSaving, setTextDialogSaving, setTextDialogError,
    showTextDialog, items, setReloadKey,
  } = data;
