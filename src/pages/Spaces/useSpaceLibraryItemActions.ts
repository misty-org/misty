...
export function useSpaceLibraryItemActions(data: SpaceLibraryData) {
  const {
    spaceId, canUploadLibrary, canEditLibrary, canCopyLibrary, collection, items, setItems, visibleItems,
    setVisibleItems, setUsage, setAssetStacks, setAlbums, setAlbumFolders, setGroups, setPeoplePolicy,
    setPeople, setDiscovery, setSharedReferences, setOutgoingReferences, setPins, setImportHistory,
    nextAfter, setNextAfter, loadingMore, setLoadingMore, libraryQuery, uploadJobs, setUploadJobs,
    selectedItems, selectedItemId, setSelectedItemId, setSelectedItemIds, bulkSaving, setBulkSaving,
    copiedEditDefinition, sensitiveCollectionToken, setLocalError, setReloadKey, metadataDialogAction,
    setMetadataDialogAction, metadataTags, setMetadataTags, metadataDate, setMetadataDate,
    metadataLocationName, setMetadataLocationName, metadataLatitude, setMetadataLatitude,
    metadataLongitude, setMetadataLongitude, setSearchInput, unlockScope, setUnlockScope, unlockPassword,
    setUnlockPassword, unlockSaving, setUnlockSaving, setSensitiveGrants,
  } = data;
