import { MockTelemetryClient } from "@/services/telemetry/client";
import {
  ANALYTICS_SESSION_TIMEOUT_MS,
  AnalyticsLifecycleManager,
} from "@/services/telemetry/lifecycle";
import type { CommonClientProperties } from "@/services/telemetry/model/interfaces/types";
