...
namespace misty::core {
    ...
    public:
        ...
        void load_themes();
        void ensure_user_assets();
        std::filesystem::path user_assets_dir() const;
        std::filesystem::path resolve_asset_path(const std::string& path);
    ...
    private:
        ...
        std::filesystem::path source_assets_dir() const;
        std::filesystem::path normalize_asset_path(const std::string& path) const;
