...
// Host filesystem services shared by scoped workers and native selection.
// Downloaded apps own their workspace behavior and presentation.
...
export function explorerDirectorySizeSnapshot(paths: string[]): Promise<DirectorySizeRecord[]> {
  return invoke("explorer_directory_size_snapshot", {
    paths,
  });
}
export function explorerCalculateDirectorySizes(
  ...
  return invoke("explorer_calculate_directory_sizes", {
    request,
  });
}
...
export function searchStartScan(request: SearchScanRequest): Promise<SearchStatus> {
  return invokeSearch("search_start_scan", {
    request,
  });
}
...
export function explorerPrepareDragItems(
  ...
  return invoke("explorer_prepare_drag_items", {
    request,
  });
}
export function explorerCancelDragPreparation(sessionId: string): Promise<void> {
  return invoke("explorer_cancel_drag_preparation", {
    sessionId,
  });
}
export function explorerPreviewItem(path: string): Promise<ExplorerPreviewPayload> {
  if (supportsBundledDocumentWorkers())
    return import("@/features/builtin-services").then(({ invokeFilesImage }) =>
      invokeFilesImage<ExplorerPreviewPayload>("explorer_preview_item", {
        path,
      }),
    );
  return invoke("explorer_preview_item", {
    path,
  });
}
export function explorerSavePreviewItem(
  ...
  return invoke("explorer_save_preview_item", {
    request,
  });
}
...
export function explorerLibraryRecordRecent(
  ...
  return invoke("explorer_library_record_recent", {
    request: {
      item,
    },
  });
...
export function explorerLibraryRecordLastOpened(path: string): Promise<ExplorerLibrarySnapshot> {
  return invoke("explorer_library_record_last_opened", {
    request: {
      path,
    },
  });
...
export function smartLibraryScan(rootPath: string): Promise<FolderLibraryStatus> {
  return invoke("smart_library_scan", {
    request: {
      rootPath,
    },
  });
...
export function smartLibraryImportFiles(paths: string[]): Promise<SmartLibraryImportResult> {
  return invoke("smart_library_import_files", {
    request: {
      paths,
    },
  });
...
export function smartLibraryPreflightImport(paths: string[]): Promise<SmartLibraryImportPreflight> {
  return invoke("smart_library_preflight_import", {
    request: {
      paths,
    },
  });
...
export async function smartLibraryPreparePreviews(
  ...
  if (!supportsBundledDocumentWorkers())
    return invoke("smart_library_prepare_previews", {
      request: {
        assetIds,
        maxDimension,
      },
  ...
  return withBuiltinService("library", spaceId, (instance) =>
    invoke("smart_library_prepare_previews", {
      instance,
      request: {
        assetIds,
        maxDimension,
...
export function smartLibraryApplyResults(results: AnalysisResult[]): Promise<SmartLibrarySnapshot> {
  return invoke("smart_library_apply_results", {
    request: {
      results,
    },
  });
...
export function smartLibrarySetServerFolderId(
  ...
  return invoke("smart_library_set_server_folder_id", {
    serverFolderId,
  });
}
...
export function smartLibraryResolveAssets(
  ...
  return invoke("smart_library_resolve_assets", {
    request: {
      assetIds,
    },
  });
...
export function smartLibraryAssetsPage(
  ...
  return invoke("smart_library_assets_page", {
    request,
  });
}
...
export function mediaSearchPrepareChunk(
  ...
  return invoke("media_search_prepare_chunk", {
    request: {
      assetId,
      chunkIndex,
    },
...
export function mediaSearchApproveAssets(assetIds: string[]): Promise<MediaSearchSnapshot> {
  return invoke("media_search_approve_assets", {
    request: {
      assetIds,
    },
  });
...
export function mediaSearchAcknowledgeRemovedAssets(
  ...
  return invoke("media_search_acknowledge_removed_assets", {
    request: {
      assetIds,
    },
  });
...
export function mediaSearchRecordChunk(
  ...
  return invoke("media_search_record_chunk", {
    request: {
      assetId,
      fingerprint,
      chunkIndex,
...
export function mediaSearchSetAssetState(
  ...
  return invoke("media_search_set_asset_state", {
    request: {
      assetId,
      state,
    },
...
export function mediaSearchCompleteLegacyAdoption(ready: boolean): Promise<MediaSearchSnapshot> {
  return invoke("media_search_complete_legacy_adoption", {
    request: {
      ready,
    },
  });
...
export function mediaSearchResolveAssets(assetIds: string[]): Promise<ResolvedMediaAsset[]> {
  return invoke("media_search_resolve_assets", {
    request: {
      assetIds,
    },
  });
...
export function explorerQueueCreateItem(
  ...
  return invoke("explorer_queue_create_item", {
    request,
  });
}
export function explorerQueueRenameItem(
  ...
  return invoke("explorer_queue_rename_item", {
    request,
  });
}
export function explorerQueueRenameItems(
  ...
  return invoke("explorer_queue_rename_items", {
    request,
  });
}
