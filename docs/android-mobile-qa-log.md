...
| Packaged permissions | Pass | Merged APK exposes `INTERNET` and Android's package-scoped dynamic-receiver permission only; no storage, package-query, install, or biometric permission. |
