    ...
    <div className="flex flex-col gap-6">
      ...
      <Section title="Devices">
        ...
        {me.tier === "basic" && (
          ...
          <a href="/hub/pricing" className="shrink-0 text-xs text-text hover:text-white underline underline-offset-2 transition-colors">
              Upgrade
            </a>
          </div>
        )}
      ...
      <Section title="Security">
        <div className="flex flex-col gap-3 py-4 md:flex-row md:items-center md:justify-between md:gap-6">
          ...
          <a href="/hub/signin" className="text-sm text-text-muted hover:text-text underline underline-offset-2 transition-colors">
            Reset
          </a>
        </div>
    ...
    <div className="flex flex-col gap-6">
      <Section title="Privacy">
        <div className="py-4 flex flex-col gap-2">
          ...
          <a href="/hub/docs" className="text-xs text-text-muted hover:text-text underline underline-offset-2 transition-colors mt-1 w-fit">
...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (!user) {
      navigate("/hub/signin", { replace: true });
      return;
    }
    if (me) return;
    setLoading(true);
