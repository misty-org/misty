...
```sh
MISTY_SDK_PROBE_TIMEOUT_SECONDS=180 node scripts/sdk-package-probe-run.ts browser ../misty-apps/.build/provider-preview
MISTY_SDK_PROBE_TIMEOUT_SECONDS=180 node scripts/sdk-package-probe-run.ts chat ../misty-apps/.build/provider-preview
MISTY_SDK_PROBE_TIMEOUT_SECONDS=180 MISTY_SDK_PROBE_PROVIDER=1 node scripts/sdk-package-probe-run.ts inbox ../misty-apps/.build/provider-preview
```
