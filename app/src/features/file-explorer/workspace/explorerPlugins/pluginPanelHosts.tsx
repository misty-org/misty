import { extensionCommandRun, pluginPanelRender } from "@/services/backend";
import type { PluginPanelEntry, PluginPanelRenderResult } from "@/services/misty/model/misty-api";
