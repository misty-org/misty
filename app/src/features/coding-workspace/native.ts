...
export function codeGitStatus(root: string): Promise<GitStatusSnapshot> {
  return invoke("code_git_status", { root });
}

export function codeGitDiff(root: string, path: string): Promise<string> {
