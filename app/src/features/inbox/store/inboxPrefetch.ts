...
import type { InboxSet } from "./useInboxStore";
...
export const detailRequests = new Map<string, Promise<InboxThread>>();

export function fetchThreadDetail(thread: InboxThread, attempts: number): Promise<InboxThread> {
...
export function applyDetailedThread(set: InboxSet, detailed: InboxThread): void {
