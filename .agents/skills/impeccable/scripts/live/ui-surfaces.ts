 ...
 *   - skill/cli/tasks/live/browser-script-parts.ts — serializes this into
 *     window.__IMPECCABLE_LIVE_UI_SURFACES__ in the /live.js prelude.
 *   - skill/cli/tasks/live-browser.js — publishes it on
 ...
 *     same path live/vocabulary.ts already takes for the command palette.
