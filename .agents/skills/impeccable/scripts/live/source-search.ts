/**
 * The project-source walk shared by live-wrap.ts and live-accept.ts.
 *
...
import { IMPECCABLE_DIR } from '../lib/impeccable-paths.ts';
import { matchesTemplateExtension } from '../lib/template-extensions.ts';
