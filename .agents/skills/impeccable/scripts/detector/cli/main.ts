...
import { loadDesignSystemForTarget } from '../design-system.ts';
import { RULE_SCOPES, filterByScopes } from '../registry/antipatterns.ts';
import { createBrowserDetector, detectUrl } from '../engines/browser/detect-url.ts';
import { detectHtml } from '../engines/static-html/detect-html.ts';
import { detectText } from '../engines/regex/detect-text.ts';
import {
  filterDetectionFindings,
  readDetectionConfig,
  shouldIgnoreDetectionFile,
} from '../../lib/impeccable-config.ts';
import {
  HTML_EXTENSIONS,
  buildImportGraph,
