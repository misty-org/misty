...
import { WELL_TIERS } from './roll-selection.ts';
...
// Defined in roll-selection.ts, the dependency-free leaf both the seeder and
...
// validation that uses it; roll-selection.ts filters on it and the seeder
