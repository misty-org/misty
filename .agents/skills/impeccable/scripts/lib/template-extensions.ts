 ...
 *
 * Before this module the answer was spelled out separately in hook-lib.ts
 * (`detector.extensions` config, issue #316) and in live-wrap.ts /
 * live-accept.ts (a hardcoded `EXTENSIONS` array, duplicated verbatim in both).
