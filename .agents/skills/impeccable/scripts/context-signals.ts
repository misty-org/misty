...
import { loadContext, extractPlatform } from './context.ts';
import { readLatestSnapshotAcrossTargets } from './critique-storage.ts';
 ...
 * `node <scripts>/detect.ts --json <targets>` and fold the hits in.
 */
