 ...
 *
 * Usage:
 *   node cli/tasks/palette.ts                  # pick at random
 *   node cli/tasks/palette.ts --id seed-021    # pick a specific seed
 *   node cli/tasks/palette.ts --from <key>     # hash <key> to a seed (deterministic)
 *
 * Env vars:
