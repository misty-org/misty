...
//
//   node embed-prompt.ts <image> --prompt "the prompt text"
//   node embed-prompt.ts <image> --prompt-file prompt.txt
//   node embed-prompt.ts <image> --read
//   node embed-prompt.ts --scan <dir...>   # list rasters missing a prompt; exit 3 when any
//
