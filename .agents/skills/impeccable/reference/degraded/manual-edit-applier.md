...
The user already clicked Apply. Do not ask what to do. Do not discard edits. Do not run `live-poll.ts`, `live-commit-manual-edits.ts`, or any live server endpoint. Do not stage, commit, rebuild, push, or edit generated provider output unless the batch explicitly targets that generated file.
