...
const linkClass =
  "w-fit text-sm leading-6 text-muted-foreground transition-colors hover:text-foreground focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring";
...
function FooterSocials() {
  return (
    <div className="mt-5 grid max-w-xs grid-cols-2 gap-x-5 gap-y-2">
      {socialLinks.map(({ label, href, icon: Icon, placeholder }) => (
        <a
          ...
          className="group flex w-fit items-center gap-2 text-sm text-muted-foreground transition-colors hover:text-foreground focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
