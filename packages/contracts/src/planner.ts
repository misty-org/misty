...
const definitionInput = model.SpaceRoadmapNodeDefinitionSchema.partial().extend(
  { name: z.string() },
);
  ...
  "roadmaps.layout.update": {
    ...
    params: z.strictObject({
      ...
      body: z.strictObject({
        ...
        milestones: z
          .array(
            model.SpaceRoadmapMilestoneSchema.partial().extend({
        ...
        goals: z
          .array(
            model.SpaceRoadmapGoalSchema.partial().extend({
              id: input.IdentifierSchema,
            }),
          )
          .nullable()
        ...
        nodes: z
          .array(
            model.SpaceRoadmapNodeSchema.partial().extend({
              id: input.IdentifierSchema,
            }),
          )
          .nullable()
