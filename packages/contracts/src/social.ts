import {z} from 'zod';
export const socialOperations=["messages","chatAgents","sendMessage","runDetail","decideRun","cancelRun","retryRun","updateMessage","deleteMessage","addMessageReaction","removeMessageReaction","markRead","conversations","createConversation","updateConversation","deleteDisconnectedConversation","deleteOrClearConversation","clearEveryoneConversation","markConversationRead","conversationMessages","sendConversationMessage","updateConversationMessage","deleteConversationMessage","addConversationMessageReaction","removeConversationMessageReaction","actionSuggestionSettings","updateActionSuggestionSettings","actionSuggestions","actionSuggestionReview","dismissActionSuggestion","acceptActionSuggestion","setConversationSuggestionVeto","conversationSuggestionVeto","members","roadmaps","nodes"] as const;
...
export const isMistySocialMethod=(method:string):method is MistySocialMethod=>Object.hasOwn(mistySocialContracts,method);
