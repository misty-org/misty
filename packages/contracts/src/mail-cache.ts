...
const records = <T extends z.ZodType>(value: T) => z.record(key, value);
...
export const MailCacheDataSchema = z
  ...
  .refine(
    (value) =>
      ...
      MISTY_MAIL_CACHE_MAX_BYTES,
    "The mail cache exceeds 32 MiB.",
  );
...
export const isMistyMailCacheMethod = (
  method: string,
): method is MistyMailCacheMethod =>
  Object.hasOwn(mistyMailCacheContracts, method);
