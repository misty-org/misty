...
const publicRoutes = [
  ...
  { name: "download", path: "/download", title: "Download Misty — macOS and Windows beta" },
  { name: "pricing", path: "/pricing", title: "Pricing — Plans for every project group | Misty" },
  { name: "features", path: "/features", title: "Features — Work together in one Space | Misty" },
  { name: "changelog", path: "/changelog", title: "Changelog — Misty beta updates" },
  { name: "blog", path: "/blog", title: "Blog — Notes from Misty" },
  { name: "roadmap", path: "/roadmap", title: "Roadmap — What Misty is building" },
  ...
  { name: "tokenless reset", path: "/reset", title: "Reset your password — Misty" },
  { name: "not found", path: "/route-that-does-not-exist", title: "Page not found — Misty" },
] as const;
