...
bool FileExplorerPanel::perform_paste_to_cloud(FileExplorerState& state,
                                               const UnifiedFileItem& item,
                                               const std::string& dest_dir,
                                               ClipboardOp op) {
    (void)state;
...
bool FileExplorerPanel::perform_paste_cloud_to_cloud(FileExplorerState& state,
                                                     const UnifiedFileItem& item,
                                                     const std::string& dest_dir,
                                                     ClipboardOp op) {
    (void)state;
...
void FileExplorerPanel::perform_paste_cloud_to_local(FileExplorerState& state,
                                                     const UnifiedFileItem& item,
                                                     const std::string& dest_dir,
                                                     ClipboardOp op) {
    (void)state;
...
bool FileExplorerPanel::delete_remote_file(const UnifiedFileItem& file,
    ...
    (void)file;
    if (error_message) {
        *error_message = "Remote delete disabled in minimalist mode.";
    }
    return false;
}
