set(MISTY_PLUGIN_API_VERSION "${PROJECT_VERSION}")
set(MISTY_PLUGIN_BUILD_ID_DEFAULT "${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}-${CMAKE_CXX_COMPILER_ID}-${CMAKE_CXX_COMPILER_VERSION}-plugin${MISTY_PLUGIN_API_VERSION}")
...
set(MISTY_BUILD_DEV_PLUGINS OFF CACHE BOOL "Build first-party development plugins for local preview and sandbox workflows")
set(MISTY_EXTERNAL_PLUGIN_DIR "/Users/mtccool668/projects/misty-plugins" CACHE PATH "External plugin source directory")
